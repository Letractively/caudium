...
//!  type: TYPE_STRING
//!
//! defvar: Garbage Collection Frequency
//! after how many connects expiration of old session should happen
//!  type: TYPE_INT
//!
//! defvar: Expiration Time
//! after how many seconds an unactive session is removed
//!  type: TYPE_INT
//!
//! defvar: Storage Method
...
//!  type: TYPE_STRING
//!
//! defvar: File Method Path
//! The storage directory for File Method
//!  type: TYPE_DIR
//!
//! defvar: Use Form based authentication
//! You can protect single URLs with a HTML based form.
//!  type: TYPE_FLAG
//!
//! defvar: Include URLs
...
//!  type: TYPE_TEXT_FIELD
//!
//! defvar: Form authentication page.
