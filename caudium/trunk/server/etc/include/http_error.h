...
class http_error_handler {
    ...
    /*
     **! method: handle_error( int _error_code, string _error_name, mixed _error_message, object id )
     ...
     **!  replace the response happing with the error page.
