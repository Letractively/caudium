...
mixed container_mailit(string tag_name, mapping arguments,
	...
	contents = Caudium.parse_html(contents,([ "mailheader":tag_header,
...
//
//! defvar: checkowner
//! If set, and Roxen is running as a sendmail trusted user, MailIt! will send the mail as the owner of the template file.
//!  type: TYPE_FLAG
//!  name: Send mail from owner of template file
//
//! defvar: enableattach
//! Enable sending of attachments? Enabling this feature has serious security implications. Do not enable this feature unless you are running the server as a non-priveledged user.
//!  type: TYPE_FLAG
//!  name: Enable sending of attachments?
//
//! defvar: mailitdebug
//! If set, MailIt! will write debugging information to the error log.
//!  type: TYPE_FLAG
...
//
//! defvar: mailport
//! The SMTP port to use when using SMTP protocol
//!  type: TYPE_INT
//!  name: SMTP port
//
...
//
//! defvar: defaultsender
//! The default sender email address, if the user doesn't specify a sender address
//!  type: TYPE_STRING
//!  name: Default Sender
//
