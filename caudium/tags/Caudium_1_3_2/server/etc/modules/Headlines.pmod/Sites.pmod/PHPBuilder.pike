...
constant name = "phpbuilder";
constant site = "PHP Builder";
constant url  = "http://www.phpbuilder.com/";
constant path  = "rss_feed.php?type=articles&limit=10";

constant names = ({ "title", "time", "description" });
constant titles = ({" Application ", " Date ", " Description " });

constant sub = "Computing/PHP";
array headlines;
